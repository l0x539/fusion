...
const NoisyBackground: FC<{
  ...
  const [
    ...
    return [
      ...
      new Color("#000"),
      new Color("#000"),
      // (new Color("#48a9b9")).lerp(new Color("#D14CA6"), 0.9), #eb006700 #4efc3f00 #55e4f200
  ...
  useEffect(() => {
    ...
    if (COMING_SOON && !searchParams.get('demo') && pathname === '/') {
      setTimeout(() => {
        defaultColor1.copy(new Color("#439393"));
        defaultColor2.copy(new Color("#0c4e23"));
        defaultColor3.copy(new Color("#245c78"));
      }, 3000)
    }
  ...
  useFrame(({clock}) => {
    ...
    if (useConstrolsColors) {
      ...
      shaderMaterialRef.current.uniforms.uColor1.value = new Color(uColor1.r/256, uColor1.g/256, uColor1.b/256).convertSRGBToLinear()
      shaderMaterialRef.current.uniforms.uColor2.value = new Color(uColor2.r/256, uColor2.g/256, uColor2.b/255).convertSRGBToLinear()
      shaderMaterialRef.current.uniforms.uColor3.value = new Color(uColor3.r/256, uColor3.g/256, uColor3.b/256).convertSRGBToLinear()
    } else {
      if (pathname === '/partners') {
