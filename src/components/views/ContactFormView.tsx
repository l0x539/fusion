...
export const SendButton: FC<{
  ...
  return <div className={`animate-fade-in flex w-full justify-center tablet:pb-14 pt-8 tablet:py-14 ${className}`}>
    <Link href={'/contact/info' + (searchParams.get('demo') ? ('?' + createQueryString('demo', `${searchParams.get('demo')}`)) : '')} className="relative group hover:cursor-pointer select-none pointer-events-auto">
