...
export const Mail = () => {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 21" fill="none">
...
export const Phone = () => {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 31" fill="none">
...
export const Paper = () => {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 31" fill="none">
